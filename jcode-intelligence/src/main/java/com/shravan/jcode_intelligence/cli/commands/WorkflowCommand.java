...
public class WorkflowCommand implements Command {
    ...
    public WorkflowCommand(ApiClient apiClient, ShellContext context, ConsoleUI consoleUI) {
    ...
    @Override
    public String description() { return "Explain a workflow or process in the active repository"; }
    ...
    public CommandResult execute(List<String> args) {
        ...
        if (args.isEmpty()) {
            consoleUI.printError("Usage: workflow <process description>");
            return CommandResult.SUCCESS;
        }
